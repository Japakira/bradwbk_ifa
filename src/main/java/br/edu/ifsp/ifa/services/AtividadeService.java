...
//                             IniciativaRepository iniciativaRepo,
//                             ResponsavelRepository responsavelRepo) {
//         this.atividadeRepo = atividadeRepo;
//         this.iniciativaRepo = iniciativaRepo;
...
//     // -------------------------------------------------------------------------
//     @Transactional(readOnly = true)
//     public List<Atividade> listarPorIniciativa(Iniciativa iniciativaId) {
//         return atividadeRepo.findByIniciativa(iniciativaId);
//     }
...
//         if (a.getIniciativa() == null || a.getIniciativa().getId() == null) {
//             throw new IllegalArgumentException("A atividade deve estar vinculada a uma iniciativa.");
//         }

//         Iniciativa ini = iniciativaRepo.findById(a.getIniciativa().getId())
//                 .orElseThrow(() -> new IllegalArgumentException("Iniciativa não encontrada"));

//         if (a.getResponsavel() != null && a.getResponsavel().getId() != null) {
//             Responsavel r = responsavelRepo.findById(a.getResponsavel().getId())
...
//     // -------------------------------------------------------------------------
//     @Transactional
//     public Optional<Atividade> atualizar(UUID id, Atividade dados) {
...
//             if (dados.getIniciativa() != null && dados.getIniciativa().getId() != null) {
//                 Iniciativa ini = iniciativaRepo.findById(dados.getIniciativa().getId())
//                         .orElseThrow(() -> new IllegalArgumentException("Iniciativa não encontrada"));
//                 existing.setIniciativa(ini);
//             }

//             if (dados.getResponsavel() != null && dados.getResponsavel().getId() != null) {
//                 Responsavel resp = responsavelRepo.findById(dados.getResponsavel().getId())
//                         .orElseThrow(() -> new IllegalArgumentException("Responsável não encontrado"));
//                 existing.setResponsavel(resp);
//             }
